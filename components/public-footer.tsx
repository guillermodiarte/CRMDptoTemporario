    ...
    <footer className="bg-slate-900 text-white w-full shrink-0 mt-20">
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">Alojamientos Di'Arte</span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed">
              Departamentos temporarios premium en Formosa, Argentina. Equipados para tu comodidad y listos para hacer de tu estadía una experiencia inigualable.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li className="flex items-start gap-3">
                ...
                <span>Antártida Argentina 1035<br />Formosa, Argentina</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+5493513146924" className="hover:text-sky-400 transition-colors">+54 9 351 314-6924</a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:contacto@alojamientosdiarte.com" className="hover:text-sky-400 transition-colors">contacto@alojamientosdiarte.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <span>© {new Date().getFullYear()} Alojamientos Di'Arte. Todos los derechos reservados.</span>
          <span>Diseño y desarrollo: Di'Arte</span>
        </div>
      </div>
    </footer>
  );
