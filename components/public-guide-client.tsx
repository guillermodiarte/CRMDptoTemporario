...
const GUIDE_ITEMS: GuideItem[] = [
  ...
  },
  {
    id: "banado-estrella",
    category: "turismo",
    title: "Bañado La Estrella (Bañado Las Estrellas)",
    subtitle: "7ª Maravilla Natural de Argentina · Gran Humedal",
    description:
      "El Bañado La Estrella (también buscado como Bañado Las Estrellas) es el segundo humedal más grande de Argentina y una de las 7 Maravillas Naturales del país. Famoso por sus 'champales' (árboles cubiertos de enredaderas sumergidos en el agua), yacarés, carpinchos y más de 300 especies de aves. Es la excursión de ecoturismo más importante de Formosa, con safaris fotográficos y paseos en piragua con guías locales desde Las Lomitas y Fortín La Soledad.",
    address: "RN 81 · Fortín La Soledad / Las Lomitas (Formosa)",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Banado+La+Estrella+Formosa",
    badge: "🦜 7ª Maravilla Natural",
    badgeColor: "bg-teal-50 text-teal-700 border-teal-200",
    highlights: [
      "Safari en piragua y kayak con guías",
      "Avistaje de yacarés, carpinchos y aves autóctonas",
      "Fotografía de 'champales' al atardecer",
      "Excursión recomendada de día completo",
    ],
    image: "/uploads/guia/formosa_banado_estrella_1787964924869.jpg",
    rating: 5,
  },
  {
    id: "tour-paraguay-alberdi",
    category: "turismo",
    title: "Tour a Paraguay: Cruce y Compras en Alberdi",
    subtitle: "Paseo en lancha y compras internacionales a minutos de Formosa",
    description:
      "Una de las experiencias y excursiones más solicitadas por quienes visitan Formosa. Se cruza en lancha de pasajeros el Río Paraguay desde el Puerto de Formosa hacia la ciudad de Alberdi (Paraguay). Famosa por sus paseos de compras a cielo abierto con excelentes precios en indumentaria, calzado, bazar, electrónica y gastronomía típica.",
    address: "Puerto de Formosa (Costanera y San Martín)",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Puerto+de+Formosa+Prefectura",
    badge: "🇵🇾 Tour a Paraguay",
    badgeColor: "bg-red-50 text-red-700 border-red-200",
    highlights: [
      "Cruce en lancha por el Río Paraguay (15 min de navegación)",
      "Paseo de compras a cielo abierto en Alberdi",
      "Cruce migratorio ágil solo con DNI argentino",
      "Gastronomía típica: sopa paraguaya, chipá y pescados de río",
    ],
    schedule: "Lanchas regulares Lun a Sáb 07:30 a 18:30 hs",
...
export function PublicGuideClient({
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc] dark:bg-slate-950 flex flex-col transition-colors duration-700 ease-in-out">
