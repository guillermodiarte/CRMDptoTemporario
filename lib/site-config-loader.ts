...
const SITE_CONFIG_KEYS = [
  ...
  "site_whatsapp_reservation_greeting",
  "site_whatsapp_reservation_footer",
  "site_whatsapp_deposit_notice",
  "site_whatsapp_admin_msg_template",
  "site_whatsapp_redirect_delay",
  "site_address",
  "site_city",
  "site_province",
  "site_country",
...
export async function getSiteConfig(): Promise<SiteConfig> {
  try {
    ...
    return {
      ...
      appIconUrl: map.get("site_app_icon_url") ?? SITE_CONFIG_DEFAULTS.appIconUrl,
      ...
      whatsappReservationGreeting: map.get("site_whatsapp_reservation_greeting") ?? SITE_CONFIG_DEFAULTS.whatsappReservationGreeting,
      whatsappReservationFooter: map.get("site_whatsapp_reservation_footer") ?? SITE_CONFIG_DEFAULTS.whatsappReservationFooter,
      whatsappDepositNotice: map.get("site_whatsapp_deposit_notice") ?? SITE_CONFIG_DEFAULTS.whatsappDepositNotice,
      whatsappAdminMsgTemplate: map.get("site_whatsapp_admin_msg_template") ?? SITE_CONFIG_DEFAULTS.whatsappAdminMsgTemplate,
      whatsappRedirectDelay: map.get("site_whatsapp_redirect_delay") ?? SITE_CONFIG_DEFAULTS.whatsappRedirectDelay,
      ...
      ogImageUrl: map.get("site_og_image_url") ?? SITE_CONFIG_DEFAULTS.ogImageUrl,
      seoDescription: map.get("site_seo_description") ?? SITE_CONFIG_DEFAULTS.seoDescription,
      seoKeywords: map.get("site_seo_keywords") ?? SITE_CONFIG_DEFAULTS.seoKeywords,
      googleVerification: map.get("site_google_verification") ?? SITE_CONFIG_DEFAULTS.googleVerification,
      ...
      quickReplies: map.get("site_quick_replies") ?? SITE_CONFIG_DEFAULTS.quickReplies,
    };
  } catch (error) {
